...
![Hình 1. Các đối tượng trong ứng dụng Project](<../.gitbook/assets/image (54) (1).png>)

**I.2. Symper Daily:** dùng để quản lý, theo dõi ngày làm việc cũng như công việc trong ngày của các thành viên trong team&#x20;

![Hình 2. Các đối tượng trong ứng dụng Symper Daily](<../.gitbook/assets/image (46).png>)

**I.3. Business Analyst:** dùng để quản lý các công việc liên quan đến nghiệp vụ của BA

![
Hình 3. Các đối tượng trong ứng dụng Business Analyst](<../.gitbook/assets/image (103).png>)

**I.4. Quality Control:** dùng để quản lý các công việc liên quan đến nghiệp vụ của QC

![Hình 4. Các đối tượng trong ứng dụng Quality Control](<../.gitbook/assets/image (74) (1).png>)
...
![Hình 5. Các đối tượng trong ứng dụng Service and Platform Control](<../.gitbook/assets/image (99) (1).png>)
